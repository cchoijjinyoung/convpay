...
class ConveniencePayServiceTest {
    ...
    void pay_success() {
        // given
        PayRequest payRequest = new PayRequest(ConvenienceType.G25, PayMethodType.MONEY, 50);
        // when
    ...
    void pay_fail() {
        // given
        PayRequest payRequest = new PayRequest(ConvenienceType.G25, PayMethodType.MONEY, 1500_001);
        // when
        PayResponse payResponse = conveniencePayService.pay(payRequest);
        // then
    ...
    void pay_cancel_success() {
        // given
        PayCancelRequest payCancelRequest = new PayCancelRequest(ConvenienceType.G25, PayMethodType.MONEY,1000);
        // when
    ...
    void pay_cancel_fail() {
        // given
        PayCancelRequest payCancelRequest = new PayCancelRequest(ConvenienceType.G25, PayMethodType.MONEY,99);
        // when
        PayCancelResponse payCancelResponse = conveniencePayService.payCancel(payCancelRequest);
        // then
